...
var fetch_from_firebase = function(){
     ...
     // Retrieve information into the fields already filled in Database
      database.on('value', function(snapshot) {
          ...
          $scope.$apply(function() {
                ...
                $scope.citizenship = citizenship;
                $scope.birthPlace = birthPlace;
                $scope.major = major;
                $scope.semester = semester;
                $scope.zip = zip;
                $scope.country = country;
                $scope.nameUni1 = nameUni1;
                $scope.fromUni1 = fromUni1;
                $scope.toUni1 = toUni1;
            });
...
//      var id = decodeURI(id);
      ...
      { var nameUni1 = "Empty"; } else { var nameUni1 = document.getElementById('nameUni1').value; }
      if(!document.getElementById('nameUni2'))
      { var nameUni2 = "Empty"; } else { var nameUni2 = document.getElementById('nameUni2').value; }
      if(!document.getElementById('nameUni3'))
      { var nameUni3 = "Empty"; } else { var nameUni3 = document.getElementById('nameUni3').value; }
      if(!document.getElementById('nameUni4'))
      { var nameUni4 = "Empty"; } else { var nameUni4 = document.getElementById('nameUni4').value; }
      if(!document.getElementById('nameUni5'))
      { var nameUni5 = "Empty"; } else { var nameUni5 = document.getElementById('nameUni5').value; }
      if(!document.getElementById('nameUni6'))
      { var nameUni6 = "Empty"; } else { var nameUni6 = document.getElementById('nameUni6').value; }
      if(!document.getElementById('nameUni7'))
      { var nameUni7 = "Empty"; } else { var nameUni7 = document.getElementById('nameUni7').value; }
      if(!document.getElementById('nameUni8'))
      { var nameUni8 = "Empty"; } else { var nameUni8 = document.getElementById('nameUni8').value; }
      if(!document.getElementById('nameUni9'))
      { var nameUni9 = "Empty"; } else { var nameUni9 = document.getElementById('nameUni9').value; }
      if(!document.getElementById('nameUni10'))
      { var nameUni10 = "Empty"; } else { var nameUni10 = document.getElementById('nameUni10').value; }
      if(!document.getElementById('fromUni1'))
      { var fromUni1 = "Empty"; } else { var fromUni1 = document.getElementById('fromUni1').value; }
      if(!document.getElementById('fromUni2'))
      { var fromUni2 = "Empty"; } else { var fromUni2 = document.getElementById('fromUni2').value; }
      if(!document.getElementById('fromUni3'))
      { var fromUni3 = "Empty"; } else { var fromUni3 = document.getElementById('fromUni3').value; }
      if(!document.getElementById('fromUni4'))
      { var fromUni4 = "Empty"; } else { var fromUni4 = document.getElementById('fromUni4').value; }
      if(!document.getElementById('fromUni5'))
      { var fromUni5 = "Empty"; } else { var fromUni5 = document.getElementById('fromUni5').value; }
      if(!document.getElementById('fromUni6'))
      { var fromUni6 = "Empty"; } else { var fromUni6 = document.getElementById('fromUni6').value; }
      if(!document.getElementById('fromUni7'))
      { var fromUni7 = "Empty"; } else { var fromUni7 = document.getElementById('fromUni7').value; }
      if(!document.getElementById('fromUni8'))
      { var fromUni8 = "Empty"; } else { var fromUni8 = document.getElementById('fromUni8').value; }
      if(!document.getElementById('fromUni9'))
      { var fromUni9 = "Empty"; } else { var fromUni9 = document.getElementById('fromUni9').value; }
      if(!document.getElementById('fromUni10'))
      { var fromUni10 = "Empty"; } else { var fromUni10 = document.getElementById('fromUni10').value; }
      if(!document.getElementById('toUni1'))
      { var toUni1 = "Empty"; } else { var toUni1 = document.getElementById('toUni1').value; }
      if(!document.getElementById('toUni2'))
      { var toUni2 = "Empty"; } else { var toUni2 = document.getElementById('toUni2').value; }
      if(!document.getElementById('toUni3'))
      { var toUni3 = "Empty"; } else { var toUni3 = document.getElementById('toUni3').value; }
      if(!document.getElementById('toUni4'))
      { var toUni4 = "Empty"; } else { var toUni4 = document.getElementById('toUni4').value; }
      if(!document.getElementById('toUni5'))
      { var toUni5 = "Empty"; } else { var toUni5 = document.getElementById('toUni5').value; }
      if(!document.getElementById('toUni6'))
      { var toUni6 = "Empty"; } else { var toUni6 = document.getElementById('toUni6').value; }
      if(!document.getElementById('toUni7'))
      { var toUni7 = "Empty"; } else { var toUni7 = document.getElementById('toUni7').value; }
      if(!document.getElementById('toUni8'))
      { var toUni8 = "Empty"; } else { var toUni8 = document.getElementById('toUni8').value; }
      if(!document.getElementById('toUni9'))
      { var toUni9 = "Empty"; } else { var toUni9 = document.getElementById('toUni9').value; }
      if(!document.getElementById('toUni10'))
      { var toUni10 = "Empty"; } else { var toUni10 = document.getElementById('toUni10').value; }                  
